...
<main class="row justify-content-center gx-0">
    <div class="col-4 text-center">
        ...
        <p class="fw-bold">Are you sure you want to deete your account?</p>
        ...
        <div class="row">
            ...
            <div class="col">
                <form action="../actions/delete-user.php" class="post">
                    <button type="submit" class="btn btn-putline-danger w-100">Delete</button>
                </form>
            </div>
        </div>
