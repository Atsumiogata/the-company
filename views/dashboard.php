                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($_SESSION['id'] == $user['id']){?>
                                <a href="edit-user.php" class="btn btn-outline-secondary border-0 btn0sm" title="Edit"><i class="fa-solid fa-user-pen"></i></a>
                                <a href="delete-user.php" class="btn btn-outline-danger border-0 btn0sm" title="Delete"><i class="fa-solid fa-user-minus"></i></a>
                            <?php
                            }?>
                        </td>
                    </tr>
